...
contract TETH is Pauseable, ERC20 {
    ...
    uint256 private totalSupp = 0;

    function setLimit(uint256 newLimit) external whenNotPaused {
        limit = newLimit;
    }

    function mint(uint256 toMint) external whenNotPaused {
        require(limit > totalSupp);
