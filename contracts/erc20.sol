...
contract TETH is Pauseable, ERC20 {

        event mintCheckEvent(address indexed minter);
        event burnCheckEvent(address indexed burner);

    constructor() ERC20("TETH", "Tokenized Eth") {}

    function mintCheck() external whenNotPaused {
        emit mintCheckEvent(msg.sender);
    }
    ...
    //This could probably share a method with mint? 
    function burnCheck() external whenNotPaused {
        emit burnCheckEvent(msg.sender);
    }
